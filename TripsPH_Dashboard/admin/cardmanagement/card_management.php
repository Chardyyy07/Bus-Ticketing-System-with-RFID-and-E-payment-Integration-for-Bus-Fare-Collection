        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="card_management.php" class="active">
                ...
                <div>
                    ...
                    <table width="100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><span class="las la-sort"></span> Card Holder ID</th>
                                <th><span class="las la-sort"></span> Card Number</th>
                                <th><span class="las la-sort"></span> Card Holder Name</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["cardholder_id"] ?></td>
                                    <td><?php echo $row["card_number"] ?></td>
                                    <td><?php echo $row["cardholder_name"] ?></td>
                                    <td><?php echo $row["cardholder_email"] ?></td>
