        ...
        <div class="side-content">
            ...
            <div class="side-menu">
                <ul>
                    ...
                    <li>
                        <a href="../person_manage/personnel_management.php" class="active">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr> <!-- back end code -->
                                                ...
                                                <td style="text-align: center; vertical-align: middle;"><?php echo $row["fullname"] ?></td>
                                                <td style="text-align: center; vertical-align: middle;"><?php echo $row["position"] ?></td>
                                                <td style="text-align: center; vertical-align: middle;"><?php echo $row["e_mail"] ?></td>
                                                <td style="text-align: center; vertical-align: middle;"><?php echo $row["contact"] ?></td>
                                                <td style="text-align: center; vertical-align: middle;"><?php echo $row["address"] ?></td>
